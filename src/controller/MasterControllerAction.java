...
public class MasterControllerAction extends ControllerAction implements EventHandler<ActionEvent> {
    ...
    private void setMenuHandlers() {
        ...
        masterView.getMenuStart().setOnAction(e -> {
            try {
                control.startGame();
        ...
        masterView.getMenuQuit().setOnAction(e -> {
            System.exit(0);
        });
    }
